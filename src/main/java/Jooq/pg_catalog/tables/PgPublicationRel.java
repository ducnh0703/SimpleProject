...
import Jooq.pg_catalog.tables.records.PgPublicationRelRecord;
...
public class PgPublicationRel extends TableImpl<PgPublicationRelRecord> {
    ...
    private static final long serialVersionUID = 1863367929;
     ...
     */
    public final TableField<PgPublicationRelRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
