...
import Jooq.pg_catalog.tables.records.PgTsConfigRecord;
...
public class PgTsConfig extends TableImpl<PgTsConfigRecord> {
    ...
    private static final long serialVersionUID = -828624554;
     ...
     */
    public final TableField<PgTsConfigRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
