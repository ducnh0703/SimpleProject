...
import Jooq.pg_catalog.tables.records.PgLargeobjectMetadataRecord;
...
public class PgLargeobjectMetadata extends TableImpl<PgLargeobjectMetadataRecord> {
    ...
    private static final long serialVersionUID = -862646556;
     ...
     */
    public final TableField<PgLargeobjectMetadataRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
