...
import Jooq.pg_catalog.tables.records.PgAmprocRecord;
...
public class PgAmproc extends TableImpl<PgAmprocRecord> {
    ...
    private static final long serialVersionUID = 340905690;
     ...
     */
    public final TableField<PgAmprocRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
