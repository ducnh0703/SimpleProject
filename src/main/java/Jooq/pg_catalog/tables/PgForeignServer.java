...
import Jooq.pg_catalog.tables.records.PgForeignServerRecord;
...
public class PgForeignServer extends TableImpl<PgForeignServerRecord> {
    ...
    private static final long serialVersionUID = -37207144;
     ...
     */
    public final TableField<PgForeignServerRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
