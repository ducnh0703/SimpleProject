...
import Jooq.pg_catalog.tables.records.PgProcRecord;
...
public class PgProc extends TableImpl<PgProcRecord> {
    ...
    private static final long serialVersionUID = 295001575;
     ...
     */
    public final TableField<PgProcRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<PgProcRecord, String> PROSUPPORT = createField("prosupport", org.jooq.impl.SQLDataType.VARCHAR.nullable(false), this, "");
