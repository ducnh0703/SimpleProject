...
import Jooq.pg_catalog.tables.records.PgTriggerRecord;
...
public class PgTrigger extends TableImpl<PgTriggerRecord> {
    ...
    private static final long serialVersionUID = -564804801;
     ...
     */
    public final TableField<PgTriggerRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
