...
import Jooq.pg_catalog.tables.records.PgStatDatabaseRecord;
...
public class PgStatDatabase extends TableImpl<PgStatDatabaseRecord> {
    ...
    private static final long serialVersionUID = -1253903100;
     ...
     */
    public final TableField<PgStatDatabaseRecord, Long> CHECKSUM_FAILURES = createField("checksum_failures", org.jooq.impl.SQLDataType.BIGINT, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_database.checksum_last_failure</code>.
     */
    public final TableField<PgStatDatabaseRecord, Timestamp> CHECKSUM_LAST_FAILURE = createField("checksum_last_failure", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
