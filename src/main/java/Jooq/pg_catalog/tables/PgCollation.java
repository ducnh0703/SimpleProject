...
import Jooq.pg_catalog.tables.records.PgCollationRecord;
...
public class PgCollation extends TableImpl<PgCollationRecord> {
    ...
    private static final long serialVersionUID = 1151462064;
     ...
     */
    public final TableField<PgCollationRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
     ...
     */
    public final TableField<PgCollationRecord, Boolean> COLLISDETERMINISTIC = createField("collisdeterministic", org.jooq.impl.SQLDataType.BOOLEAN.nullable(false), this, "");
