...
import Jooq.pg_catalog.tables.records.PgConversionRecord;
...
public class PgConversion extends TableImpl<PgConversionRecord> {
    ...
    private static final long serialVersionUID = -379457674;
     ...
     */
    public final TableField<PgConversionRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
