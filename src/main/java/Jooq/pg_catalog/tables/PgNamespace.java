...
import Jooq.pg_catalog.tables.records.PgNamespaceRecord;
...
public class PgNamespace extends TableImpl<PgNamespaceRecord> {
    ...
    private static final long serialVersionUID = -1699308754;
     ...
     */
    public final TableField<PgNamespaceRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
