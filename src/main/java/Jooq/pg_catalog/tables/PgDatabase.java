...
import Jooq.pg_catalog.tables.records.PgDatabaseRecord;
...
public class PgDatabase extends TableImpl<PgDatabaseRecord> {
    ...
    private static final long serialVersionUID = 1083396625;
     ...
     */
    public final TableField<PgDatabaseRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
