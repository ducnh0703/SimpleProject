...
import Jooq.pg_catalog.tables.records.PgTsTemplateRecord;
...
public class PgTsTemplate extends TableImpl<PgTsTemplateRecord> {
    ...
    private static final long serialVersionUID = 175378445;
     ...
     */
    public final TableField<PgTsTemplateRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
