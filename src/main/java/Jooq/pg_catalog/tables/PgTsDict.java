...
import Jooq.pg_catalog.tables.records.PgTsDictRecord;
...
public class PgTsDict extends TableImpl<PgTsDictRecord> {
    ...
    private static final long serialVersionUID = 174316730;
     ...
     */
    public final TableField<PgTsDictRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
