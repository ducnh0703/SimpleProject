...
import Jooq.pg_catalog.tables.records.PgStatisticExtRecord;
...
public class PgStatisticExt extends TableImpl<PgStatisticExtRecord> {
    ...
    private static final long serialVersionUID = -2135057304;
     ...
     */
    public final TableField<PgStatisticExtRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
