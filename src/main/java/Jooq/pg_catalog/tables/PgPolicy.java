...
import Jooq.pg_catalog.tables.records.PgPolicyRecord;
...
public class PgPolicy extends TableImpl<PgPolicyRecord> {
    ...
    private static final long serialVersionUID = -1771739643;
     ...
     */
    public final TableField<PgPolicyRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
