...
import Jooq.pg_catalog.tables.records.PgDefaultAclRecord;
...
public class PgDefaultAcl extends TableImpl<PgDefaultAclRecord> {
    ...
    private static final long serialVersionUID = 1188747377;
     ...
     */
    public final TableField<PgDefaultAclRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
