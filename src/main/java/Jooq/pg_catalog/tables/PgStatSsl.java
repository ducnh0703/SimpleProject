...
import Jooq.pg_catalog.tables.records.PgStatSslRecord;
...
public class PgStatSsl extends TableImpl<PgStatSslRecord> {
    ...
    private static final long serialVersionUID = -318691437;
     ...
     */
    public final TableField<PgStatSslRecord, String> CLIENT_DN = createField("client_dn", org.jooq.impl.SQLDataType.CLOB, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_ssl.client_serial</code>.
     */
    public final TableField<PgStatSslRecord, BigDecimal> CLIENT_SERIAL = createField("client_serial", org.jooq.impl.SQLDataType.NUMERIC, this, "");

    /**
     * The column <code>pg_catalog.pg_stat_ssl.issuer_dn</code>.
     */
    public final TableField<PgStatSslRecord, String> ISSUER_DN = createField("issuer_dn", org.jooq.impl.SQLDataType.CLOB, this, "");
