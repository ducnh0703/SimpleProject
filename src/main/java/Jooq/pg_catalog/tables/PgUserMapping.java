...
import Jooq.pg_catalog.tables.records.PgUserMappingRecord;
...
public class PgUserMapping extends TableImpl<PgUserMappingRecord> {
    ...
    private static final long serialVersionUID = 1584949051;
     ...
     */
    public final TableField<PgUserMappingRecord, Long> OID = createField("oid", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
