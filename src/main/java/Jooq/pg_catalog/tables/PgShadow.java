...
import Jooq.pg_catalog.tables.records.PgShadowRecord;
...
public class PgShadow extends TableImpl<PgShadowRecord> {
    ...
    private static final long serialVersionUID = -1868302566;
     ...
     */
    public final TableField<PgShadowRecord, Timestamp> VALUNTIL = createField("valuntil", org.jooq.impl.SQLDataType.TIMESTAMP, this, "");
