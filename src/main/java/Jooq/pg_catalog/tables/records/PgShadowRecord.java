...
public class PgShadowRecord extends TableRecordImpl<PgShadowRecord> implements Record9<String, Long, Boolean, Boolean, Boolean, Boolean, String, Timestamp, String[]> {

    private static final long serialVersionUID = 736868864;
     ...
     */
    public void setValuntil(Timestamp value) {
        set(7, value);
    }
     ...
     */
    @Override
    public Row9<String, Long, Boolean, Boolean, Boolean, Boolean, String, Timestamp, String[]> fieldsRow() {
     ...
     */
    @Override
    public Row9<String, Long, Boolean, Boolean, Boolean, Boolean, String, Timestamp, String[]> valuesRow() {
     ...
     */
    @Override
    public PgShadowRecord value8(Timestamp value) {
        setValuntil(value);
        return this;
    }
     ...
     */
    @Override
    public PgShadowRecord values(String value1, Long value2, Boolean value3, Boolean value4, Boolean value5, Boolean value6, String value7, Timestamp value8, String[] value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PgShadowRecord(String usename, Long usesysid, Boolean usecreatedb, Boolean usesuper, Boolean userepl, Boolean usebypassrls, String passwd, Timestamp valuntil, String[] useconfig) {
        super(PgShadow.PG_SHADOW);
