...
public class PgCastRecord extends TableRecordImpl<PgCastRecord> implements Record6<Long, Long, Long, Long, String, String> {

    private static final long serialVersionUID = -320501721;
