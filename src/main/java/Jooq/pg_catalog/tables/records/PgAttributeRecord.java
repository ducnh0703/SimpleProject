...
public class PgAttributeRecord extends TableRecordImpl<PgAttributeRecord> {
    ...
    private static final long serialVersionUID = -1841634462;
     ...
     */
    public PgAttributeRecord(Long attrelid, String attname, Long atttypid, Integer attstattarget, Short attlen, Short attnum, Integer attndims, Integer attcacheoff, Integer atttypmod, Boolean attbyval, String attstorage, String attalign, Boolean attnotnull, Boolean atthasdef, Boolean atthasmissing, String attidentity, String attgenerated, Boolean attisdropped, Boolean attislocal, Integer attinhcount, Long attcollation, String[] attacl, String[] attoptions, String[] attfdwoptions, Object attmissingval) {
        super(PgAttribute.PG_ATTRIBUTE);
        ...
        set(21, attacl);
        set(22, attoptions);
        set(23, attfdwoptions);
        set(24, attmissingval);
    }
}
