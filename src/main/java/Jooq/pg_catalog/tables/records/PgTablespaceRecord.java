...
public class PgTablespaceRecord extends TableRecordImpl<PgTablespaceRecord> implements Record5<Long, String, Long, String[], String[]> {

    private static final long serialVersionUID = 1215805856;
