...
public class PgTsDictRecord extends TableRecordImpl<PgTsDictRecord> implements Record6<Long, String, Long, Long, Long, String> {

    private static final long serialVersionUID = 1507746644;
